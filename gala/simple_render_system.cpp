...
namespace gala {
	...
	SimpleRenderSystem::SimpleRenderSystem(GalaDevice& device, VkRenderPass renderPass, VkDescriptorSetLayout globalSetLayout)
		: galaDevice{ device } {
	...
	void SimpleRenderSystem::renderGameObjects(FrameInfo& frameInfo, std::vector<GalaGameObject>& gameObjects)
	{
		galaPipeline->bind(frameInfo.commandBuffer);
